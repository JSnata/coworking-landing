  ...
  return (
    <section className="pt-navbar min-h-screen flex flex-col justify-center text-center bg-hero bg-cover bg-center">
      <div className="container">
        ...
        <form className="bg-white rounded-lg shadow-md px-3 py-5 flex flex-col md:flex-row items-center justify-center max-w-3xl mx-auto mb-6">
        <div className="w-full md:flex-1 md:mr-7">
          <SelectBox options={["Select Location"]} />
        </div>
        <div className="w-full md:flex-1 md:mr-0">
          <DateInput />
        </div>
